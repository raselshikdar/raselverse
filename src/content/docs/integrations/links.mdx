...
export const integ: IntegrationUserConfig = {
  links: {
    ...
    applyTip: {
      ...
      url: 'https://raselverse.vercel.app/',
      avatar: 'https://raselverse.vercel.app/favicon/favicon.ico'
    }
  },
}
```
...
1. Fork the [Friend-Circle-Lite](https://github.com/raselshikdar/friend-circle-lite).
