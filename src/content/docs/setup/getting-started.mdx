...
1. Install the theme
   ...
   <TabItem label='bun'>
   ```shell
   bun create astro@latest --template raselshikdar/raselverse
   ```
   <Aside type='tip'>
   ...
   <TabItem label='pnpm'>
   ```shell
   pnpm create astro@latest --template raselshikdar/raselverse
   ```
   </TabItem>
   <TabItem label='yarn'>
   ```shell
   yarn create astro --template raselshikdar/raselverse
   ```
   </TabItem>
   <TabItem label='npm'>
   ```shell
   npm create astro@latest -- --template raselshikdar/raselverse
   ```
   </TabItem>
   </Tabs>

   By default, this command will use the template repository’s main branch. To use a different branch name, pass it as part of the `--template` argument: `raselshikdar/raselverse#<branch>`.
...
You only need to [click fork button at theme repository](https://github.com/raselshikdar/raselverse/fork) to create your project; then clone the forked repository to your local machine.
...
5. Configure the site
   ...
   export const theme: ThemeUserConfig = {
      ...
      title: 'raselverse',
      site: 'raselverse.vercel.app',
      description: 'Rise, reflect and strive.',
      // ...
   }
